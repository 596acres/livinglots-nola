...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.has_blight_liens'
        db.add_column(u'lots_lot', 'has_blight_liens',
    ...
    def backwards(self, orm):
        # Deleting field 'Lot.has_blight_liens'
        db.delete_column(u'lots_lot', 'has_blight_liens')
