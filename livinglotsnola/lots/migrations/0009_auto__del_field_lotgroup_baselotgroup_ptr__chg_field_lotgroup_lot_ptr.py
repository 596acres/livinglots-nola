...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LotGroup.baselotgroup_ptr'
        db.delete_column(u'lots_lotgroup', u'baselotgroup_ptr_id')


        # Changing field 'LotGroup.lot_ptr'
        db.alter_column(u'lots_lotgroup', u'lot_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lots.Lot'], unique=True, primary_key=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LotGroup.baselotgroup_ptr'
        raise RuntimeError("Cannot reverse this migration. 'LotGroup.baselotgroup_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'LotGroup.baselotgroup_ptr'
        db.add_column(u'lots_lotgroup', u'baselotgroup_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['livinglots_lots.BaseLotGroup'], unique=True, primary_key=True),
                      keep_default=False)


        # Changing field 'LotGroup.lot_ptr'
        db.alter_column(u'lots_lotgroup', u'lot_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lots.Lot'], unique=True))
