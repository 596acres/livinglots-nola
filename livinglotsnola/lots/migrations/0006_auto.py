...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field uncommitted_properties on 'Lot'
        m2m_table_name = db.shorten_name(u'lots_lot_uncommitted_properties')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lot', models.ForeignKey(orm[u'lots.lot'], null=False)),
            ('uncommittedproperty', models.ForeignKey(orm[u'nora.uncommittedproperty'], null=False))
        ))
        db.create_unique(m2m_table_name, ['lot_id', 'uncommittedproperty_id'])


    def backwards(self, orm):
        # Removing M2M table for field uncommitted_properties on 'Lot'
        db.delete_table(db.shorten_name(u'lots_lot_uncommitted_properties'))
