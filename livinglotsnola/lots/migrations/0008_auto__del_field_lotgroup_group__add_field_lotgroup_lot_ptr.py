...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LotGroup.lot_ptr'
        db.add_column(u'lots_lotgroup', u'lot_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['lots.Lot'], unique=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LotGroup.lot_ptr'
        db.delete_column(u'lots_lotgroup', u'lot_ptr_id')
    ...
    models = {
        ...
        u'lots.lotgroup': {
            'Meta': {'object_name': 'LotGroup', '_ormbases': [u'livinglots_lots.BaseLotGroup', u'lots.Lot']},
            ...
            u'lot_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['lots.Lot']", 'unique': 'True'})
        },
