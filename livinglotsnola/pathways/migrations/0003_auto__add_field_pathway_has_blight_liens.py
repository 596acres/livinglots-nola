...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pathway.has_blight_liens'
        db.add_column(u'pathways_pathway', 'has_blight_liens',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pathway.has_blight_liens'
        db.delete_column(u'pathways_pathway', 'has_blight_liens')
    ...
    models = {
        ...
        u'pathways.pathway': {
            ...
            'has_blight_liens': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
